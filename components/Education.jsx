  ...
  return (
    <div className="my-4 p-[var(--main-padding)] rounded-lg p-6 card flex flex-col gap-3">
      ...
      <div className="flex flex-col bg-gray-100/90 p-3 rounded-md">
        <span className="text-[16px] md:main-font-size font-bold">ماجستير في القانون</span>
      ...
      <div className="flex flex-col bg-gray-100/90 p-3 rounded-md">
        <span className="text-[16px] md:main-font-size font-bold">برنامج القيادة التنفيذية</span>
      ...
      <div className="flex flex-col bg-gray-100/90 p-3 rounded-md">
        <span className="text-[16px] md:main-font-size font-bold">الذكاء الاصطناعي للمحامين | برنامج تنفيذي</span>
      ...
      <div className="flex flex-col bg-gray-100/90 p-3 rounded-md">
        <span className="text-[16px] md:main-font-size font-bold">الحوكمة البيئية والاجتماعية والنشاط الاجتماعي | برنامج تنفيذي</span>
        <span className="sub-font-size">جامعة بنسلفانيا</span>
      </div>

      {/* جامعة أنهوك المكسيك الشمالية - القانون التجاري الدولي */}
      <div className="flex flex-col bg-gray-100/90 p-3 rounded-md">
        <span className="text-[16px] md:main-font-size font-bold">القانون التجاري الدولي | برنامج تنفيذي</span>
        <span className="sub-font-size">جامعة أنهوك المكسيك الشمالية</span>
      </div>

      {/* جامعة لوند - الذكاء الاصطناعي والقانون */}
      <div className="flex flex-col bg-gray-100/90 p-3 rounded-md">
        <span className="text-[16px] md:main-font-size font-bold">الذكاء الاصطناعي والقانون | برنامج تنفيذي</span>
        <span className="sub-font-size">جامعة لوند</span>
      </div>

      {/* جامعة نجران - بكالوريوس قانون */}
      <div className="flex flex-col bg-gray-100/90 p-3 rounded-md">
        <span className="text-[16px] md:main-font-size font-bold">بكالوريوس في القانون</span>
